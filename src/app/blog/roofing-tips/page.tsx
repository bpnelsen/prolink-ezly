    ...
    <main className="max-w-3xl mx-auto px-6 py-12">
      <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-6">
        <ol className="flex items-center gap-2">
          ...
          <li aria-hidden="true">/</li>
          <li className="text-gray-700 line-clamp-1" aria-current="page">5 Roofing Efficiency Hacks for Contractors</li>
        </ol>
      </nav>
      <img src="/blog/roofing-tips.jpg" alt="" className="w-full rounded-2xl mb-8 object-cover" style={{ height:"320px", width:"100%" }} />
