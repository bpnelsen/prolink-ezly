      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-white border-2 border-gray-200 rounded-xl hover:border-[#0f3a7d] hover:bg-gray-50 transition font-semibold text-gray-700 flex items-center justify-center gap-3 text-sm disabled:opacity-50 mb-5"
          >
